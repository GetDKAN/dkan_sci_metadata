...
class Variables {
  ...
  function numbers() {
    return [
      ...
      'edition',
      //(container) edition holding the item (e.g. “3” when citing a chapter in the third
      //edition of a book)
      'issue',
      //(container) issue holding the item (e.g. “5” when citing a journal article from
  ...
  function standards() {
    return [
      ...
      'authority',
      //issuing or judicial authority (e.g. “USPTO” for a patent, “Fairfax Circuit Court” for
      //a legal case)
      'call-number',
      //call number (to locate the item in a library)
      'citation-label',
      //label identifying the item in in-text citations of label styles (e.g. “Ferr78”). May
      //be assigned by the CSL processor based on item metadata.
      'citation-number',
      //index (starting at 1) of the cited reference in the bibliography (generated by the CSL
      //processor)
      'collection-title',
      ...
      //short/abbreviated form of “container-title” (also accessible through the “short” form
      ...
      //number of a preceding note containing the first reference to the item. Assigned
      ...
      'locator',
      //a cite-specific pinpointer within the item (e.g. a page number within a book, or a
      ...
      'original-title',
      //title of the original version (e.g. “Война и мир”, the untranslated Russian title of
      // “War and Peace”)
      'page',
      //range of pages the item (e.g. a journal article) covers in a container (e.g. a journal
      // issue)
      'page-first',
      //first page of the range of pages the item (e.g. a journal article) covers in a
      ...
      'title-short',
      //short/abbreviated form of “title” (also accessible through the “short” form of the
      //“title” variable)
      'URL',
  ...
  public static function isDateVariable($name) {
    return in_array($name, self::dates());
  }
  ...
  public static function isNumberVariable($name) {
    return in_array($name, self::numbers());
  }
